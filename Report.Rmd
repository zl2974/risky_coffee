...
1. General Addiction Model of *hour_day_risk ~ ticket + borough + s(hour) + weekday* with _poison()_ family and addressing that most tickets is issued during office hour.
